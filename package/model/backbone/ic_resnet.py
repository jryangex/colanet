...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,kernel_size=3, activation='ReLU'):
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, activation='ReLU',kernel_size=3):
...
class Ic_resnet50(nn.Module):
    ...
    def __init__(self,
        ...
        super(Ic_resnet50, self).__init__()
        global pattern
